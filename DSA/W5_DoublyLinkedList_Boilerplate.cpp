...
public:
    ...
    // Task 2: return the previous position in O(1)
    Position previous(Position pos) {
        throw logic_error("Task 2 not implemented");
    }

    // Task 3: insert x after p and repair both link directions
    void insert(ElementType x, Position p = NULL) {
        throw logic_error("Task 3 not implemented");
    }

    // Task 4: delete the node after p and repair both link directions
    ...
    // Task 8: print from head to tail
    void print_list() {
        throw logic_error("Task 8 not implemented");
    }

    // Task 9: print from tail to head using prev links
    void print_reverse() {
...
int main() {
    ...
    // list.insert(15, list.locate(10));
    // list.print_list();

    // list.delete_at(list.locate(20));
    // list.print_list();
    // list.print_reverse();
