...
int main() {
    ...
    SinglyLinkedList merged = SinglyLinkedList::merge_lists(l1, l2);
    merged.print("Merged list: ");

    merged.swap_adjacent_at(2);
    merged.print("After swapping positions 2 and 3: ");
    ...
    duplicates.insert(1);
    duplicates.insert(4);
    duplicates.print("Before purge: ");
    duplicates.purge();
    duplicates.print("After purge: ");

    cout << "Locate 3 in range [2, 4]: "
         << duplicates.locate_in_range(3, 2, 4) << endl;

    SinglyLinkedList sorted_single;
    sorted_single.insert_sorted(30);
    sorted_single.insert_sorted(10);
    sorted_single.insert_sorted(20);
    sorted_single.insert_sorted(20);
    sorted_single.print("Sorted singly list: ");
    ...
    doubly.insert(15);
    doubly.insert(20);
    doubly.print("Before swap: ");
    doubly.swap_adjacent_at(3);
    doubly.print("After swapping positions 3 and 4: ");

    DoublyLinkedList sorted_double;
    sorted_double.insert_sorted(25);
    sorted_double.insert_sorted(5);
    sorted_double.insert_sorted(15);
    sorted_double.insert_sorted(10);
    sorted_double.print("Sorted doubly list: ");

    cout << endl << "===== Stack Assignment =====" << endl;
    string exp1 = "{[(a+b) * c] - d}";
    string exp2 = "{[(a+b] * c) - d}";
    cout << exp1 << " -> "
         << (is_balanced(exp1) ? "Balanced" : "Not balanced") << endl;
    cout << exp2 << " -> "
         << (is_balanced(exp2) ? "Balanced" : "Not balanced") << endl;

    cout << endl << "===== Queue Assignment =====" << endl;
    queue<int> q;
    q.push(1);
    q.push(2);
    q.push(3);
    ...
    reverse_queue(q);
    print_queue(q, "Reversed queue: ");

    cout << "rotator -> "
         << (is_palindrome("rotator") ? "Palindrome" : "Not palindrome") << endl;
    cout << "data -> "
         << (is_palindrome("data") ? "Palindrome" : "Not palindrome") << endl;
